  ...
  Data = {
    set(e, t, n) {
      ...
      i.has(t) || 0 === i.size
        ? i.set(t, n)
        : console.error(
            `UX4G doesn't allow more than one instance per element. Bound instance: ${Array.from(i.keys())[0]}.`,
          );
    },
...
class Carousel extends BaseComponent {
  ...
  _slide(e, t = null) {
    ...
    (s.classList.add(c), reflow(s), n.classList.add(l), s.classList.add(l));
    (this._queueCallback(
      () => {
